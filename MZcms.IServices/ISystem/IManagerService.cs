...
namespace MZcms.IServices
{
    public interface IManagerService : IService
    {
        ...
        /// <param name="query"></param>
        /// <returns></returns>
        QueryPageModel<Managers> GetSellerManagers(ManagerQuery query);
        ...
        /// <returns></returns>
        Managers GetSellerManagerByShopId(long shopId);
        ...
        /// <param name="shopId"></param>
        /// <returns></returns>
        IQueryable<Managers> GetSellerManagerByRoleId(long roleId, long shopId);

        /// <summary>
        /// 获取当前登录的商家管理员
        /// </summary>
        /// <returns></returns>
        Managers GetSellerManager(long userId);
        /// <summary>
        /// 添加一个平台管理员
        /// </summary>
        ...
        Managers AddSellerManager(string username, string password, string salt);
        ...
        void AddSellerManager(Managers model, string currentSellerName);
        /// <summary>
        /// 修改平台管理员密码和角色
        /// </summary>
        /// <param name="model"></param>
        ...
        /// </summary>
        /// <param name="model"></param>
        void ChangeSellerManager(Managers info);
        ...
        /// <returns></returns>
        Managers Login(string username, string password, bool isPlatFormManager = false);
        ...
        /// <param name="userName"></param>
        /// <returns></returns>
        Managers GetSellerManager(string userName);
    }
}
