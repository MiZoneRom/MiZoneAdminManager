...
namespace MZcms.Application
{
    public class ManagerApplication
    {
        ...
        /// <returns></returns>
        public static QueryPageModel<Managers> GetPlatformManagers(ManagerQuery query)
        {
        ...
        /// <param name="query"></param>
        /// <returns></returns>
        public static QueryPageModel<Managers> GetSellerManagers(ManagerQuery query)
        {
        ...
        /// <returns></returns>
        public static IQueryable<Managers> GetPlatformManagerByRoleId(long roleId)
        {
        ...
        /// <returns></returns>
        public static Managers GetSellerManagerByShopId(long shopId)
        {
        ...
        /// <param name="shopId"></param>
        /// <returns></returns>
        public static IQueryable<Managers> GetSellerManagerByRoleId(long roleId, long shopId)
        {
        ...
        public static void AddPlatformManager(Managers model)
        {
        ...
        public static Managers AddSellerManager(string username, string password, string salt)
        {
        ...
        public static void AddSellerManager(Managers model, string currentSellerName)
        {
        ...
        /// </summary>
        /// <param name="model"></param>
        public static void ChangeSellerManager(Managers info)
        {
        ...
        /// <returns></returns>
        public static IQueryable<Managers> GetManagers(string keyWords)
        {
        ...
        /// <param name="userName"></param>
        /// <returns></returns>
        public static Managers GetSellerManager(string userName)
        {
