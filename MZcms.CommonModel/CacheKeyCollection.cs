...
namespace MZcms.CommonModel
{
    ...
    public static class CacheKeyCollection
    {
        ...
        public const string CACH_BARGAINCONFIG = "CACH_BARGAINCONFIG";
        ...
        public const string CACHE_BARGAINPRODUCTS = "CACHE_BARGAINPRODUCTS";
        ...
        public static string CACHE_PRODUCTBARGAINNOTSTART(long id)
        {
            return string.Format("CACHE_PRODUCTBARGAINNOTSTART_{0}", id);
        }
